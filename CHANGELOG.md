...
- Wizard UX: add "None/Skip" options for plugins, test runner, linter
- askPlugins: confirm-first pattern + "none" option
- askProviders: confirm-first + default value (opencode-go)
- askTestRunner/askLinter: add "사용 안 함 / 해당 없음" option
